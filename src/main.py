...
def pipeline(image):
    ...
    bbox = []
    bbox.extend(gbb.find_cars(image, 400, 656, 1.0, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    bbox.extend(gbb.find_cars(image, 400, 656, 1.2, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    bbox.extend(gbb.find_cars(image, 400, 656, 1.4, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    bbox.extend(gbb.find_cars(image, 400, 656, 1.6, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    bbox.extend(gbb.find_cars(image, 400, 656, 1.8, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    bbox.extend(gbb.find_cars(image, 400, 656, 2.0, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins))
    ...
    heat = rfp.apply_threshold(heat,5)
